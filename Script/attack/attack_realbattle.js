...
var RealEffect = defineObject(BaseCustomEffect,
{
	...
	moveEffect: function() {
		...
		// EnemyOffsetControl.checkOffset should be called immediately after the frame has advanced.
		// If you miss this timing, the enemy's offset (position change) will be delayed by one frame.
		if (this._isHitCheck) {
